...
class DashboardService {
    ...
    `, { type: sequelize.QueryTypes.SELECT });
        ...
        const credTotal = (totalCreditos && totalCreditos[0]) ? totalCreditos[0].total : 0;
        const debTotal = (totalDebitos && totalDebitos[0]) ? totalDebitos[0].total : 0;

        const repassesPendentes = (parseFloat(credTotal || 0) - parseFloat(debTotal || 0));
